<a href="https://github.com/itsmfknlucy">
  <picture>
    ...
    <img src="https://raw.githubusercontent.com/itsmfknlucy/itsmfknlucy/production/assets/profile-light.svg" alt="Lucifer Rodstark terminal profile card" width="100%">
  </picture>
</a>
...
```text
context → requirements → architecture → implementation → testing
        → security and performance review → deployment readiness
